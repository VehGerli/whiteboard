     ...
     var toolbar = function () {
          ...
          try {
               ...
               (() => {
                    ...
                    //добавляем класс к активной кнопки, снимая его же с остальных кнопок
               ...
               (() => {
                    ...
                    $(`${this.containerSelector} #toolbar .extended-buttons button`).click(function () {
                         ...
                         if (id === 'save') {
                              ...
                              if (window.confirm('Уверены, что хотите все удалить?')) {
              ...
              <div class="custom-modal-content">
               ...
               console.error("Ошибка! Панель инструментов не была создана!");
          }
     }
